...
export function DashboardHeader({ hasAlerts }: { hasAlerts: boolean }) {
  ...
  return (
    <View style={styles.row}>
      ...
      >
        <IconSymbol size={20} name="exclamationmark.triangle.fill" color={glass.glassSurface.textSecondary} />
...
const createStyles = (glass: RuntimeGlassTheme) => StyleSheet.create({
  ...
  logoMark: {
    ...
    backgroundColor: glass.accentAlpha("cyan", 0.12),
    borderWidth: 1,
    borderColor: glass.glassSurface.border,
  },
  logoGlyph: { color: glass.glassPalette.cyan, fontWeight: "900", fontSize: 14, letterSpacing: 1 },
  title: { color: glass.glassSurface.textPrimary, fontSize: 17, fontWeight: "800", letterSpacing: 0.3 },
  subtitle: { color: glass.glassSurface.textSecondary, fontSize: 10, fontWeight: "700", letterSpacing: 1.6 },
  bell: {
    width: 44,
    height: 44,
    borderRadius: 22,
  ...
  bellPressed: { backgroundColor: glass.glassDepth.glass },
  alertDot: {
    position: "absolute",
    top: 8,
    right: 8,
    ...
    height: 8,
    borderRadius: 4,
    backgroundColor: glass.glassPalette.cyan,
    shadowColor: glass.glassPalette.cyan,
    shadowOpacity: 0.9,
    shadowRadius: 6,
