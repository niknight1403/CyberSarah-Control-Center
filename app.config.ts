...
// Dark-Cyber-Punchlist: mit der Capacitor-Build-Identitaet (android/app/build.gradle
// applicationId) ausgerichtet — EAS-Config und APK verwenden jetzt dieselbe Paket-ID.
const rawBundleId = "com.cybersarah.controlcenter";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appSlug: "custom-ai-studio-mobile",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "/manus-storage/custom-ai-studio-icon_4c79bf2f.png",
