...
import { evaluateUsageBudget, type BudgetResult } from "@/lib/usage-budget-logic";
  ...
  const refresh = useCallback(async () => {
    ...
    if (qualityResult.status === "fulfilled" && qualityResult.value) {
      try {
        ...
        const budgetResult = evaluateUsageBudget([], {
