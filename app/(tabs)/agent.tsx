...
export default function AgentScreen() {
  ...
  const exportBackup = async () => {
    ...
    try {
      ...
      setBackupMessage(`${result.filename} wurde verschlüsselt erzeugt und an das System-Menü übergeben.`);
    } catch (error) {
