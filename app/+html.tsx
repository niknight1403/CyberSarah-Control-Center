...
<style id="cs-startup-style">
  ...
  .cs-startup-track::after { content: ""; display: block; width: 42%; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #19E6FF, #F02DFF); animation: cs-loading 1.2s ease-in-out infinite; }
